...
@Table(name = "`TABLE1`", uniqueConstraints = {
            @UniqueConstraint(name = "`UK_TABLE1_COLUMN3`", columnNames = {"`COLUMN3`"})})
public class Table1 implements Serializable {

    private Integer id;
    @WMValueInject( type = VariableType.APP_ENVIRONMENT, name = "testprop", scopes = { Scope.INSERT, Scope.UPDATE })
