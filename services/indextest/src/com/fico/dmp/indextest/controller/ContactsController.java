...
import com.fico.dmp.indextest.service.ContactsService;
 ...
 * @see Contacts
 */
@RestController("indextest.ContactsController")
@Api(value = "ContactsController", description = "Exposes APIs to work with Contacts resource.")
@RequestMapping("/indextest/Contacts")
public class ContactsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ContactsController.class);

    @Autowired
	@Qualifier("indextest.ContactsService")
    ...
    public Contacts editContacts(@PathVariable("id") Integer id, @RequestBody Contacts contacts) {
        LOGGER.debug("Editing Contacts with id: {}" , contacts.getContactId());
