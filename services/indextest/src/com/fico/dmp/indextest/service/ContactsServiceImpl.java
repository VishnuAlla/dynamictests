...
import com.fico.dmp.indextest.Contacts;
 ...
 * @see Contacts
 */
@Service("indextest.ContactsService")
@Validated
public class ContactsServiceImpl implements ContactsService {
    ...
    @Autowired
    @Qualifier("indextest.ContactsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service indextest for table Contacts to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service indextest for table Contacts to {} format", options.getExportType());
