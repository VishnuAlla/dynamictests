...
import com.fico.dmp.indextest.Table1;
 ...
 * @see Table1
 */
@Service("indextest.Table1Service")
@Validated
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(readOnly = true, value = "indextestTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "indextestTransactionManager")
    @Override
    public Table1 getByColumn3(String column3) {
        Map<String, Object> column3Map = new HashMap<>();
        column3Map.put("column3", column3);

        LOGGER.debug("Finding Table1 by unique keys: {}", column3Map);
        return this.wmGenericDao.findByUniqueKey(column3Map);
    }

    @Transactional(rollbackFor = EntityNotFoundException.class, value = "indextestTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "indextestTransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service indextest for table Table1 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service indextest for table Table1 to {} format", options.getExportType());
