...
package com.fico.dmp.testdynamic.service;
...
import com.fico.dmp.testdynamic.FawbPropertySource;
 ...
 */
@Service("testdynamic.FawbPropertySourceService")
@Validated
public class FawbPropertySourceServiceImpl implements FawbPropertySourceService {
    ...
    @Autowired
    @Qualifier("testdynamic.FawbPropertySourceDao")
    ...
    @Transactional(value = "testdynamicTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "testdynamicTransactionManager")
    @Override
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "testdynamicTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "testdynamicTransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service testdynamic for table FawbPropertySource to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service testdynamic for table FawbPropertySource to {} format", options.getExportType());
