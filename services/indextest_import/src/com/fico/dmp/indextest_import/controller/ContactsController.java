...
import com.fico.dmp.indextest_import.service.ContactsService;
 ...
 * @see Contacts
 */
@RestController("indextest_import.ContactsController")
@Api(value = "ContactsController", description = "Exposes APIs to work with Contacts resource.")
@RequestMapping("/indextest_import/Contacts")
public class ContactsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ContactsController.class);

    @Autowired
	@Qualifier("indextest_import.ContactsService")
