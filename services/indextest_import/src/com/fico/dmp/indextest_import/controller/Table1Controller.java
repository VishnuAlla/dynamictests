...
import com.fico.dmp.indextest_import.Table1;
import com.fico.dmp.indextest_import.service.Table1Service;
...
public class Table1Controller {
    ...
    @ApiOperation(value = "Returns the matching Table1 with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table1 getByColumn3(@PathVariable("column3") String column3) {
        LOGGER.debug("Getting Table1 with uniques key Column3");
        return table1Service.getByColumn3(column3);
    }
