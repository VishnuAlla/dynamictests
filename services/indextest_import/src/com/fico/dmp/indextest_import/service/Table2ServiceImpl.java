 ...
 * @see Table2
 */
@Service("indextest_import.Table2Service")
@Validated
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("indextest_import.Table2Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service indextest_import for table Table2 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service indextest_import for table Table2 to {} format", options.getExportType());
