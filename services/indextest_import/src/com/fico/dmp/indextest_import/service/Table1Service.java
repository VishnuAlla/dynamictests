...
public interface Table1Service {
    ...
    /**
     * Find and return the Table1 for given column3  if exists.
     *
     * @param column3 value of column3; value cannot be null.
     * @return Table1 associated with the given inputs.
     * @throws EntityNotFoundException if no matching Table1 found.
     */
    Table1 getByColumn3(String column3);
